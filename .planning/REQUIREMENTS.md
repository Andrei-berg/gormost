...
- [ ] **HR-04**: ЗАМОРАБ (только своя служба) и ADMIN (все службы) могут сменить статус сотрудника одной кнопкой: На работе / Отгул / Больничный / Отпуск / Уволен
- [x] **HR-05**: Пользователь видит сводку на сегодня — сколько работает / отсутствует по каждой службе
- [ ] **HR-06**: Пользователь видит историю изменений статуса по каждому сотруднику
