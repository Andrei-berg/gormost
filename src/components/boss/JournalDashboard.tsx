...
export default function JournalDashboard() {
  ...
  // Items grouped per object (for the object breakdown)
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="glass rounded-xl px-4 py-3 flex flex-wrap items-center gap-3">
        <span className="text-sm font-bold text-white">📒 План дня · из журнала</span>
      ...
      {loading ? <PanelLoader /> : items.length === 0 ? (
        <EmptyState message="На эту дату планов в журнале нет" />
      ) : (
        <>
          {/* KPI strip */}
